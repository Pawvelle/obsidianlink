...
- E11: `unit_verified`；geometry VERIFIED；live #1 `portal_activation_not_observed`；diagnostic `p1-e11-diag-001` Case F / `ROOT_CAUSE_NARROWED`；`integration_verified`: NO。
...
- E11: `unit_verified`；runtime geometry deployed / real verified YES；live #1 attempted YES (`portal_activation_not_observed`)；diagnostic `p1-e11-diag-001` Case F / `ROOT_CAUSE_NARROWED`；`integration_verified`: NO；
- E12: NOT STARTED；P1 Hard Gate: NOT PASSED；P2: NOT STARTED；
