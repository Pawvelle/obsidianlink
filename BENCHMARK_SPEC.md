...
当前只能声称 v2 architecture/scope frozen、legacy infrastructure preserved、P1 E0–E10 runtime 离线 `unit_verified`，以及已审查的真实 E0 lifecycle、E1 RGB（360×640×3 uint8）、E2 inventory、E3 selected-item、E4 camera、E5 movement、E6 block-placement、E7 WATER/LAVA bucket-usage、E8 block-truth 与 E9 WATER/LAVA fluid-truth success evidence。历史 E5/E8/E9 reset failures 是同一 LWJGL Sound engine infrastructure fingerprint，不是对应 capability failure；证据仍保留。Audio mitigation 后的 startup validation 在 20 个 fresh processes 中观察到 20/20 first-attempt success，native crash、Malmo EOF、timeout 和 cleanup failure 均为 0；有限样本不证明绝对可靠，attempt-014 历史根因仍未证明。E0–E10 都不是 `integration_verified`。E10 真实 calibration 尚未运行。E11/E12 尚未开始、没有 end-to-end task implementation、没有 Multi-Agent gameplay、没有 formal dataset 或 benchmark evaluation。P1 Hard Gate 未通过，P2 不得开始。
