...
def _offline_contract_check() -> dict[str, object]:
    ...
    return {
        ...
        "note": (
            ...
            "marshal, paused-executor, diagnostic, and E12 patches. Its single "
            "real E11 calibration used one accepted flint_and_steel action and "
            "zero retries, but produced fire and 0/6 nether_portal with "
            "truth_missing_count=0; outcome portal_activation_not_observed. "
