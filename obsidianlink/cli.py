...
def _offline_contract_check() -> dict[str, object]:
    ...
    return {
        ...
        "note": (
            ...
            "integration_verified. The clean canonical completion-barrier runtime "
            "excludes old marshal, paused-executor, diagnostic, and E12 patches. "
            "One authorized E11 real run used one fresh process, one reset, zero "
            "retry, and exactly one accepted use_item(flint_and_steel); its server "
