...
def _offline_contract_check() -> dict[str, object]:
    ...
    return {
        ...
        "note": (
            ...
            "writes from the Render thread. One marshal live "
            "(p1-e11-live-002) timed out waiting on server.execute "
            "while the integrated server was paused; E11 real reviewed "
            "success is NO and is not integration_verified. "
