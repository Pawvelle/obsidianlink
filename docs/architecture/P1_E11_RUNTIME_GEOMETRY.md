...
`runs/history/p1-e11-live-20260816-001/`. An instrumented diagnostic
clone `p1-e11-diag-001` later showed Case F on a temporary logging-only
JAR that was restored afterward; see
[P1 E11 diagnostic runtime](P1_E11_DIAGNOSTIC_RUNTIME.md). This
document remains geometry provenance; it does not set
