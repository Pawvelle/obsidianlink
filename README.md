...
下一项 P1 工作是经授权把 portal placement marshal 到 server thread。不能为确认再跑，不能改 geometry/evaluator/window，不能开始 E12。P1 的 hard gate 仍要求完整 E0–E12 suite 稳定重复成功、`truth_missing=0`、无人工干预。
