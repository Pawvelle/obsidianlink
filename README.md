...
下一步不是自动重跑 E9 WATER，也不是开始 E9 LAVA 或 E10。需要单独授权一次独立的 E9 WATER 真实 MineRL retry。P1 的 hard gate 是稳定重复成功、`truth_missing=0`、无人工干预；建议至少 20 个 fresh episodes，最终次数在实验冻结阶段确定。
